...
public class Main {
    ...
    public static Book[] PromptCheckOut(Book[] books) {
        boolean choice = Console.PromptForYesNo("Would you like to check out a book ?");
        if (choice) {
            String bookTitle = Console.PromptForString("Enter the available book name you wish to check out: ");
    ...
    public static Book[] PromptCheckIn(Book[] books) {
